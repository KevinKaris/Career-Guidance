...
?>
    <form id="edit" action="add.php" method="post">
        <input type="text" name="course-name" class="form-control" placeholder="Enter course name...">
        ...
        <input type="text" name="minimum_grade" class="form-control" placeholder="Enter course name" placeholder="Enter minimum grade...">
        <input type="text" name="language_grade_required" class="form-control" placeholder="Enter language grade required...">
        <input type="text" name="bio_chem_grade_required" class="form-control" placeholder="Enter bio chem grade required...">
        <input type="text" name="physics_grade_required" class="form-control" placeholder="Enter physics grade required...">
        <input type="text" name="mathematics_grade_required" class="form-control" placeholder="Enter mathematics grade required...">
